...
# ===================================================================
# NAT Gateway for Private Subnet (Lambda가 AWS 서비스에 접근하기 위해 필요)
# ===================================================================
...
resource "aws_eip" "nat" {
  ...
  tags = {
    Name = "${var.project_name}-${var.session_id}-nat-eip"
  }
...
resource "aws_nat_gateway" "main" {
  ...
  tags = {
    Name = "${var.project_name}-${var.session_id}-nat-gw"
  }

  depends_on = [aws_internet_gateway.main]
}

# Route Table for Private Subnet (NAT Gateway를 통해 인터넷 접근)
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = "${var.project_name}-${var.session_id}-private-rt"
  }
}
